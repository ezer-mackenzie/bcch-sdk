...
- Nueva — `src/bcch_sdk/types/auth.py` + `bcch_sdk/mappers/credentials.py`:
  ...
  - `CredentialsMapper.to_query_credentials` transforma un `InternalCredentials` a `{"user": ..., "pass": ...}`. ([bcch_sdk/mappers/credentials.py](https://github.com/ezer-mackenzie/bcch-sdk/blob/main/bcch_sdk/mappers/credentials.py))
...
- Nueva: `ParameterBuilder.build_get_series_params` usa `timeseries` también (coincide), pero el API público de Python usa `time_series` como argumento y `TimeSeriesBuilder` normaliza entradas. Ver [src/bcch_sdk/builders/parameters.py](https://github.com/ezer-mackenzie/bcch-sdk/blob/main/src/bcch_sdk/builders/parameters.py) y [src/bcch_sdk/builders/time_series.py](https://github.com/ezer-mackenzie/bcch-sdk/blob/main/src/bcch_sdk/builders/time_series.py).
